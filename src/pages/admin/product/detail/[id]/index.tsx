...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableRow, Paper, Button, Select, MenuItem, FormControl, InputLabel, Modal } from '@mui/material';
...
const ProductDetail = () => {
    ...
    useEffect(() => {
        ...
        // Determine the endpoint dynamically based on type (en or mn)
        const endpoint = type === 'en' ? `findEn/${id}` : `findMn/${id}`;

        // Fetch product details using the `id` and `type`
        axios
            .get(`http://103.50.205.86:9000/api/v1/superadmin/product/${endpoint}`, {
                headers: {
        ...
        <>
            <Box sx={{ backgroundColor: '#0d0d0d', color: '#ffffff' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4, alignItems: 'center' }}>
                    ...
                    <Box>
                        <img
                            src={product.imagesPathEn ||  product.imagesPathMn} // Use placeholder image if no product image
                            ...
                            <Table>
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell sx={{ color: '#ffffff' }}>${product.priceEn || product.priceMn}</TableCell>
                                    </TableRow>
                                    <TableRow>
